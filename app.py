...
st.set_page_config(page_title="Nebula Zenith Sanctuary", layout="wide", initial_sidebar_state="collapsed")
...
avatar_file = "images/nebula_blink.png" if st.session_state.is_currently_blinking else f"images/{stage}.png"
...
# Autonomic Blink Logic [cite: 2026-02-13]
now = time.time()
